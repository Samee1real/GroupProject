 ...
 * @author nisha
 */
public class EndFrameWin extends javax.swing.JFrame {

    /**
     * Creates new form EndFrameWin
     */
    public EndFrameWin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        quitBtn2.setBackground(new java.awt.Color(153, 153, 255));
        quitBtn2.setFont(new java.awt.Font("Nirmala UI Semilight", 1, 24)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EndFrameWin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
